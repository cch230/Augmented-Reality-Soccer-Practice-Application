package com.example.tracking_ver3;
...
public class MainActivity extends AppCompatActivity
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        Imgproc.GaussianBlur(matResult, matGaussian, s, 0, 0);
...
//                max_contour = contours.get(idx);
//                Rect rect = Imgproc.boundingRect(contours.get(idx));
//                if(rect.height>10){
//                    Imgproc.circle(matInput,new Point((rect.br().x+rect.x)/2,(rect.br().y+rect.y)/2),rect.width/2,new Scalar(0,0,255),4);
//                    Imgproc.circle(matInput,new Point((rect.br().x+rect.x)/2,(rect.br().y+rect.y)/2),5,new Scalar(0,0,255),1);
//                }
////                deque.add(0,new Point((rect.br().x+rect.x)/2,(rect.br().y+rect.y)/2));
//               for(int i=0;i<deque.size();i++){
//                   if(deque.get(i-1)==null && deque.get(i)==null)
//                       continue;
//                   int thickness = (int)Math.sqrt(40 / (float)((i + 1)) * 5);
//                   Imgproc.line(matInput,deque.get(i-1),deque.get(i),new Scalar(0,0,255),thickness);
//                }
        return matInput;
    }
