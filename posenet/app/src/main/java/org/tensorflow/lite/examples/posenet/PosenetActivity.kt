...
class PosenetActivity :
  ...
  public fun getAngel(start:PointF, end:PointF):Double{
    val dy:Float= end.y-start.y
    val dx:Float = end.x-start.x
    val result:Double= Math.atan2(dy.toDouble(),dx.toDouble())*(180.0/Math.PI)
    return result
  }
  /**
