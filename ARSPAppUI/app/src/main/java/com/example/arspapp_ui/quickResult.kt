...
class quickResult : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var aty: Activity? = quick_camera.CameraActivity
        aty!!.finish()

        videoView=findViewById(R.id.playTextureView3)
        imageView3=findViewById(R.id.grade3)
        textView=findViewById(R.id.gradePoint3)
        ...
        var result_data=""
        val sharedPreferences = getSharedPreferences("quick", 0)
