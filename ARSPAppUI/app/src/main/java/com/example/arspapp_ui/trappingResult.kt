...
class trappingResult : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(grade>=60) imageView3!!.setImageResource(R.drawable.a)
        else if(grade>=50) imageView3!!.setImageResource(R.drawable.b)
        else if(grade>=40) imageView3!!.setImageResource(R.drawable.c)
        else if(grade>=30) imageView3!!.setImageResource(R.drawable.d)
        else if(grade>=20) imageView3!!.setImageResource(R.drawable.e)
        else if(grade>=10) imageView3!!.setImageResource(R.drawable.f)
        else imageView3!!.setImageResource(R.drawable.x)
    }
